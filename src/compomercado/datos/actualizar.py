...
def actualizar_todo(proyecto: Proyecto) -> dict[str, list[str]]:
    ...
    alm.registrar_descarga("yahoo", tickers=len(tickers), fallidos=fallidos)
    ...
    alm.registrar_descarga("fred", series=len(series), fallidos=fallidas)
    ...
    alm.registrar_descarga("cboe", series=len(proyecto.series_cboe), fallidos=fallidos_cboe)
    ...
    alm.registrar_descarga("ken_french", series=len(proyecto.ken_french), fallidos=fallos["ken_french"])
